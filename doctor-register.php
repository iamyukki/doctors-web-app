<?php 
	...
	session_start();
	if(isset($_SESSION['role'])) header('doctor-profile-settings.php');
	if(isset($_POST['submit'])){
		$doctor = new Doctor($conn, $_POST['fname'], $_POST['lname'], $_POST['email'], $_POST['password']);
		$doctor->register();
	}
								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>Doctor Register <a href="client-register.php">Not a Doctor?</a></h3>
										</div>
										...
										<form action="doctor-register.php" method="post">
											...
											<?php if(isset($_POST['submit'])) $doctor->checkForm(); ?>
